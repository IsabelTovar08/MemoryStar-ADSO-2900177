...
<style>
    body{
        background-image: url('img/fondoTematicas/tecno.gif');
    }
</style>
<body>
                ...
                <div class="contenedorCartas">
                        <div class="carta"  data-id="auri">
                            <div class="cara reverso">
                                <img src="img/cartasTecnologia/auri.jpg
                                " class="imagen">
                            </div>
                        ...
                        <div class="carta" data-id="cel">
                            <div class="cara reverso">
                                <img src="img/cartasTecnologia/cel.jpg
                                " class="imagen">
                            </div>
                            <div class="cara frente">
                                <img src="img/Cartalogorehecha.png" class="imagen" alt="Reverso">
                    ...
                    <div class="carta"  data-id="cpu">
                        <div class="cara reverso">
                            <img src="img/cartasTecnologia/cpu.jpg" class="imagen">
                        </div>
                        <div class="cara frente">
                            <img src="img/Cartalogorehecha.png" class="imagen" alt="Reverso">
                        </div>
