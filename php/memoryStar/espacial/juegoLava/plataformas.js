...
export function createPlatforms(scene) {
  const platformPositions = [
    ...
    { x: 540, y: scene.scale.height - 400, scale: 0.2,asset: 'hielo'},
    // { x: 240, y: scene.scale.height - 400, scale: 0.1,asset: '111'},
    // { x: 140, y: scene.scale.height - 400, scale: 0.1,asset: '111'},
    { x: 380, y: scene.scale.height - 400, scale: 0.2,asset: 'hielo'},
    { x: 0, y: scene.scale.height - 400, scale: 0.2,asset: 'hielo'},
    ...
    { x: 1000, y: scene.scale.height - 310, scale: 0.1,asset: '111'},
    { x: 1000, y: scene.scale.height - 500, scale: 0.1,asset: '111'},
    
    
    { x: 1200, y: scene.scale.height - 220, scale: 0.1,asset: '111'},    
    { x: 1200, y: scene.scale.height - 410, scale: 0.1,asset: '111'},    
