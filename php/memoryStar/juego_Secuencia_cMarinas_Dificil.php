        ...
        <div id="contenedor">
            <div class="contenido arrastrar">
                ...
                <div class="dropzones-container">
                    ...
                    <div id="mantarraya" class="dropzone"></div>
                    <div id="foca" class="dropzone"></div>
                </div>
                <div id="start-zone" class="start-zone">
                    <img src="img/criaturasMarinas/foca.jpg" alt="" id="foca" draggable="true" class="draggable">
                    ...
                    <img src="img/criaturasMarinas/mantarraya.jpg" alt="" id="mantarraya" draggable="true" class="draggable">
                </div>
