...
<head>
    ...
    <title>juego Tecnologia Medio </title>
...
<style>
    body {
    background-image: url('../../img/fondoTematicas/fondoTecnologia.jpg');
...
<body class="fondo">
    ...
    <div class="contenedor">
        ...
        <div class="carta" data-id="cpu">
            <div class="cara reverso">
                <img src="../../img/cartasTecnologia/cpu.jpg
                " class="imagen">
            </div>
            <div class="cara frente">
                <img src="../../img/Cartalogorehecha.png" class="imagen" alt="Reverso">
        ...
        <div class="carta"  data-id="tecla">
            <div class="cara reverso">
                <img src="../../img/cartasTecnologia/tecla.jpg" class="imagen">
            </div>
            <div class="cara frente">
                <img src="../../img/Cartalogorehecha.png" class="imagen" alt="Reverso">
            </div>
        </div>
        <div class="carta"  data-id="disco">
            <div class="cara reverso">
                <img src="../../img/cartasTecnologia/disco.jpg" class="imagen">
            </div>
            <div class="cara frente">
                <img src="../../img/Cartalogorehecha.png" class="imagen" alt="Reverso">
            </div>
   ...
   <a href="tecnologiaDificil.php"><button class="btn btn-primary  botonesCartas ">Siguiente</button></a>
