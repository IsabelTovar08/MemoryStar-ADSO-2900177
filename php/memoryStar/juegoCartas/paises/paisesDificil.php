...
<head>
    ...
    <title>juego Paises Dificil </title>
...
<body class="fondo">
    ...
    <div class="contenedor">
        ...
        <div class="carta"  data-id="inglaterra">
            <div class="cara reverso">
                <img src="../../img/cartasPaises/inglaterra.jpg" class="imagen">
            </div>
            <div class="cara frente">
                <img src="../../img/Cartalogorehecha.png" class="imagen" alt="Reverso">
            </div>
        ...
        <div class="carta"  data-id="mexico">
            <div class="cara reverso">
                <img src="../../img/cartasPaises/mexico.jpg" class="imagen">
            </div>
            <div class="cara frente">
                <img src="../../img/Cartalogorehecha.png" class="imagen" alt="Reverso">
            </div>
